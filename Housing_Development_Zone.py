...
development_permits_data = development_permits_data.rename(
    columns={"COMM_NAME": "CommunityName"}
)


agg_data = development_permits_data.groupby("CommunityName", as_index=False)[
    "CommunityCode"
].count()
